...
function AccordionItem({ q, a }: { q: string; a: React.ReactNode }) {
  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        <span className="text-[15px] font-semibold text-gray-900" style={{ fontFamily: "var(--font-ibm-plex-sans)" }}>
          {q}
        </span>
        <span
      ...
      >
        <div className="text-[15px] text-gray-500 leading-relaxed pb-5">{a}</div>
      </div>
    </div>
  );
}
