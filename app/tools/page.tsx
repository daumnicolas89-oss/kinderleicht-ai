    ...
    <>
      <section className="relative overflow-hidden bg-white pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold uppercase tracking-widest mb-5" style={{ color: "#2596be" }}>KI-Tools</p>
          ...
          <p className="mt-6 text-xl text-gray-500 leading-relaxed max-w-xl mx-auto">
            Sorgfältig ausgewählte KI-Tools wie Canva, Claude und ChatGPT mit Erklärungen und konkreten Einsatzideen für den Bildungsbereich.
          </p>
        </div>
      </section>
