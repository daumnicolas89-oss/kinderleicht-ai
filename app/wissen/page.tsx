    ...
    <>
      <section className="relative overflow-hidden bg-white pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold uppercase tracking-widest mb-5" style={{ color: "#2596be" }}>Wissen</p>
          ...
          <p className="mt-6 text-xl text-gray-500 leading-relaxed max-w-xl mx-auto">
            Hintergrundartikel, Erklärungen und Einordnungen rund um KI in Kita, Schule und Betreuung. Fundiert und ohne Fachjargon.
          </p>
        </div>
      </section>
