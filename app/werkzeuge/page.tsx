...
export const metadata: Metadata = {
  title: "Werkzeuge — kinderleicht.ai",
  description: "Kuratierte KI-Tools für Erzieher und Lehrkräfte.",
};
      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-gray-500 leading-relaxed">
            Sorgfältig ausgewählte KI-Tools aus dem Netz — mit Erklärungen und
            konkreten Einsatzideen für den Bildungsbereich. Kein Overload, nur
            das Nützliche.
          </p>
        </div>

        <div className="mt-16 py-16 border border-gray-100 rounded-xl bg-[#F5F5F7] text-center">
          <p className="text-gray-400 text-sm">Werkzeuge werden in Kürze veröffentlicht.</p>
        </div>
      </div>
    </section>
  );
