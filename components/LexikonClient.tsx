                  ...
                  {grouped[letter].map((entry) => {
                    ...
                    return (
                      <Link
                        ...
                        className="group block rounded-2xl border border-gray-100 bg-white p-6 hover:border-[#2596be]/30 hover:shadow-lg hover:-translate-y-0.5 active:scale-[0.96] transition-all duration-300"
                      >
