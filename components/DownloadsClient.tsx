            ...
            {filtered.map((dl) => {
              return (
                <Link
                  ...
                  className="group flex flex-col bg-white rounded-2xl border border-gray-100 hover:border-[#2596be]/20 hover:shadow-md hover:-translate-y-0.5 active:scale-[0.96] transition-all duration-300 overflow-hidden"
                >
