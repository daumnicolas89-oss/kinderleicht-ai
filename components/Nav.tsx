          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-1">
              <a
                ...
                aria-label="LinkedIn"
                className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-600 hover:bg-gray-50 transition-all"
              >
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:text-[#2596be] transition-colors"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span
                aria-label="Facebook"
                className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-300 cursor-default"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
